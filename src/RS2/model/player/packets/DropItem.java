...
public class DropItem implements PacketType {
	...
	public void processPacket(Client c, int packetType, int packetSize) {
        ...
        if (c.inventory.getItemAmounts()[slot] != 0 && itemId != -1 && c.inventory.getItemIds()[slot] == itemId + 1) {
			if(droppable) {
                ...
                GameEngine.itemHandler.createGroundItem(c, itemId, c.getX(), c.getY(), c.inventory.getItemAmounts()[slot], c.getId());
                c.getItems().deleteItem(itemId, slot, c.inventory.getItemAmounts()[slot]);
			} else {
