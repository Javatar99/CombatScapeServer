...
public class BankX2 implements PacketType {
	...
	public void processPacket(Client c, int packetType, int packetSize) {
		...
		switch(c.xInterfaceId) {
			case 5064:
				c.getItems().bankItem(c.inventory.getItemIds()[c.xRemoveSlot], c.xRemoveSlot, Xamount);
			break;
				
			case 5382:
				c.getItems().fromBank(c.bank.getItemIds()[c.xRemoveSlot], c.xRemoveSlot, Xamount);
			break;
