...
public class CombatAssistant {
	...
	public int getWepAnim(String weaponName) {
		...
		switch (c.equipment.getItemIds()[c.playerWeapon]) { // if you don't want to use
														// strings
		case 6522:
			return 2614;
	...
	public int getBlockEmote() {
		if (c.equipment.getItemIds()[c.playerShield] >= 8844
				&& c.equipment.getItemIds()[c.playerShield] <= 8850) {
			return 4177;
		}
		switch (c.equipment.getItemIds()[c.playerWeapon]) {
		case 4755:
