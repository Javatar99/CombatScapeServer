...
public class PlayerSave {
			...
			if (spot > -1) {
				...
				case 3:
					if (token.equals("character-equip")) {
						p.equipment.getItemIds()[Integer.parseInt(token3[0])] = Integer
								.parseInt(token3[1]);
						p.equipment.getItemAmounts()[Integer.parseInt(token3[0])] = Integer
								.parseInt(token3[2]);
					}
					break;
				case 4:
				...
				case 6:
					if (token.equals("character-item")) {
						p.inventory.getItemIds()[Integer.parseInt(token3[0])] = Integer
								.parseInt(token3[1]);
						p.inventory.getItemAmounts()[Integer.parseInt(token3[0])] = Integer
								.parseInt(token3[2]);
					}
					break;
				case 7:
					if (token.equals("character-bank")) {
						p.bank.getItemIds()[Integer.parseInt(token3[0])] = Integer
								.parseInt(token3[1]);
						p.bank.getItemAmounts()[Integer.parseInt(token3[0])] = Integer
								.parseInt(token3[2]);
					}
					break;
				case 8:
	...
	public static boolean saveGame(Client p) {
		...
		try {
			...
			characterfile.newLine();
			for (int i = 0; i < p.equipment.getItemIds().length; i++) {
				characterfile.write("character-equip = ", 0, 18);
				characterfile.write(Integer.toString(i), 0, Integer.toString(i)
						.length());
				characterfile.write("	", 0, 1);
				characterfile.write(Integer.toString(p.equipment.getItemIds()[i]), 0,
						Integer.toString(p.equipment.getItemIds()[i]).length());
				characterfile.write("	", 0, 1);
				characterfile.write(Integer.toString(p.equipment.getItemAmounts()[i]), 0,
						Integer.toString(p.equipment.getItemAmounts()[i]).length());
				characterfile.write("	", 0, 1);
				characterfile.newLine();
			}
			characterfile.newLine();
			...
			characterfile.newLine();
			for (int i = 0; i < p.inventory.getItemIds().length; i++) {
				if (p.inventory.getItemIds()[i] > 0) {
					characterfile.write("character-item = ", 0, 17);
					characterfile.write(Integer.toString(i), 0, Integer
							.toString(i).length());
					characterfile.write("	", 0, 1);
					characterfile.write(Integer.toString(p.inventory.getItemIds()[i]), 0,
							Integer.toString(p.inventory.getItemIds()[i]).length());
					characterfile.write("	", 0, 1);
					characterfile.write(Integer.toString(p.inventory.getItemAmounts()[i]), 0,
							Integer.toString(p.inventory.getItemAmounts()[i]).length());
					characterfile.newLine();
				}
			}
			characterfile.newLine();
			...
			characterfile.newLine();
			for (int i = 0; i < p.bank.getItemIds().length; i++) {
				if (p.bank.getItemIds()[i] > 0) {
					characterfile.write("character-bank = ", 0, 17);
					characterfile.write(Integer.toString(i), 0, Integer
							.toString(i).length());
					characterfile.write("	", 0, 1);
					characterfile.write(Integer.toString(p.bank.getItemIds()[i]), 0,
							Integer.toString(p.bank.getItemIds()[i]).length());
					characterfile.write("	", 0, 1);
					characterfile.write(Integer.toString(p.bank.getItemAmounts()[i]), 0,
							Integer.toString(p.bank.getItemAmounts()[i]).length());
					characterfile.newLine();
				}
			}
			characterfile.newLine();
